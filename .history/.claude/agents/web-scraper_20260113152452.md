...
2. **What's the objective'?** (e.g., find a new job, analyze the competition to help my business standout, analyze the market for a new business idea)
3. **Which websites or what kind of sources?** (specific URLs or general search)
4. **What columns do you need?** (e.g., name, price, URL, description, date)
5. **How many results?** (approximate number of rows)
