...
cd /Users/cinziapalumbo/Documents/Claude Code Projects/2026 Job Search/Claude Daily Job Search   # ← Change this to your actual path
...
Save to output/jobs_$(date +%Y-%m-%d).csv"